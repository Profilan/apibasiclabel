...
class LeverancierMapper implements MapperInterface
{
    ...
    {
        $item = $this->entityManager->getRepository('POS\V1\Rest\Leverancier\LeverancierEntity')->findBy(array(
               'suppliercode' => $id 
            ))[0];
    ...
    {
        $items = $this->entityManager->getRepository('POS\V1\Rest\Leverancier\LeverancierEntity')->findAll();
    ...
    {
        $item = $this->entityManager->find('POS\V1\Rest\Leverancier\LeverancierEntity', $id);
