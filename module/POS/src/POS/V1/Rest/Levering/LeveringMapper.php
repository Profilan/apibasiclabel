...
class LeveringMapper implements MapperInterface
{
    ...
    {
        $item = $this->entityManager->find('Webshop\\V1\Rest\Levering\LeveringEntity', $id);
    ...
    public function fetchAll($params = array())
    {
        if ($params->get('REFERENTIE')) {
            $items = $this->entityManager->getRepository('Webshop\\V1\Rest\Levering\LeveringEntity')->findBy(array(
               'referentie' => $params->get('REFERENTIE') 
            ));
        } else {
            $items = $this->entityManager->getRepository('Webshop\\V1\Rest\Levering\LeveringEntity')->findAll();
        }
