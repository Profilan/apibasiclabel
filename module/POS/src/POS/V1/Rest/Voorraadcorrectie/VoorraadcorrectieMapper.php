...
class VoorraadcorrectieMapper implements MapperInterface
{
    ...
    {
        $item = $this->entityManager->find('Webshop\\V1\Rest\Voorraadcorrectie\VoorraadcorrectieEntity', $id);
    ...
    public function fetchAll($params = array())
    {
        if ($params->get('ITEMCODE')) {
            $items = $this->entityManager->getRepository('Webshop\\V1\Rest\Voorraadcorrectie\VoorraadcorrectieEntity')->findBy(array(
               'itemcode' => $params->get('ITEMCODE') 
            ));
        } else {
            $items = $this->entityManager->getRepository('Webshop\\V1\Rest\Voorraadcorrectie\VoorraadcorrectieEntity')->findAll();
        }
